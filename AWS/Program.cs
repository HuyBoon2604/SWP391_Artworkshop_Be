...
builder.Services.AddDbContext<ARTWORKPLATFORMContext>(op =>op.UseSqlServer(builder.Configuration.GetConnectionString("Artwork")));
...
builder.Services.AddScoped<IOrderCusArt, SOrderCusArt>();
builder.Services.AddScoped<IPaymentCusArt, SPaymentCusArt>();
